...
If an image is attached, describe what you SEE in the image — the actual visual content, axes, labels, patterns, colors. Then connect it to the experimental data from the context.
